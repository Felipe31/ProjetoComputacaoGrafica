...
//  spotlight
//
//  Created by Mauren Louise Sguario on 08/11/17.
//  Copyright © 2017 Mauren Louise Sguario. All rights reserved.
//
...
{
    printf("Interaction:");
    printf("Press the page up/down arrow keys to increase/decrease the spotlight cone angle.");
    printf("Press the arrow keys to move the spotlight.");
    printf("Press 't/T' to decrease/increase the spotlight's attenuation.");
}
